            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full rounded-xl border bg-white px-4 py-2.5 text-sm outline-none transition-all focus:ring-2 focus:ring-blue-100 ${errors.url ? "border-red-500" : "border-gray-300"}`}
                  {...register("url")}
                />
                {errors.url && (
                  <p className="text-red-500 text-xs mt-1">
              ...
              >
                <div className="flex flex-row items-center justify-between mb-2">
                  ...
                  <TabsList className="grid grid-cols-2 w-[180px] h-9 bg-gray-100/80 rounded-lg">
                    ...
                    >
                      <MapPin className="w-3.5 h-3.5 mr-1.5" /> Địa chỉ
                    </TabsTrigger>
                    <TabsTrigger
                      value="coordinate"
                      className="text-xs font-medium"
                    >
                      <Locate className="w-3.5 h-3.5 mr-1.5" /> Tọa độ
                    </TabsTrigger>
                  </TabsList>
                </div>
                <TabsContent value="address" className="mt-0">
                  <input
                    ...
                    className={`w-full rounded-xl border bg-white px-4 py-2.5 text-sm outline-none transition-all focus:ring-2 focus:ring-blue-100 ${errors.address ? "border-red-500" : "border-gray-300"}`}
                    {...register("address")}
                  />
                  {errors.address && (
                    <p className="text-red-500 text-xs mt-1">
                  ...
                  <button
                    ...
                    className="mt-2.5 w-full rounded-xl bg-[#56d376] py-2.5 text-sm text-white font-bold hover:bg-[#48b865] transition-colors shadow-sm"
                  >
                    Xác nhận địa chỉ
                  </button>
                </TabsContent>
                <TabsContent value="coordinate" className="mt-0">
                  <input
                    ...
                    className={`w-full rounded-xl border bg-gray-50 px-4 py-2.5 text-sm outline-none ${errors.locate ? "border-red-500" : "border-gray-300"}`}
                    readOnly
                    {...register("locate")}
                  />
                  {errors.locate && (
                  ...
                  <button
                    ...
                    className="mt-2.5 w-full rounded-xl bg-[#56d376] hover:bg-[#48b865] py-2.5 text-sm text-white font-bold transition-colors shadow-sm"
                  >
                    Lấy vị trí hiện tại
                  </button>
                </TabsContent>
