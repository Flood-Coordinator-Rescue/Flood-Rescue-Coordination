...
export default function FindRequestPage() {
  const { phoneInput, setPhoneInput, isLoading, apiResponse, handleSearch } = useFindRequest()
            ...
            <table className="w-full min-w-[600px] text-left border-collapse">
              <thead>
                <tr className="bg-blue-500 text-white">
                  <th className="p-3 font-semibold border border-blue-400 text-center">ID đội</th>
              ...
              <tbody>
                <tr className="bg-white text-gray-700">
                  ...
                  <td className="p-3 border border-gray-400 text-center">{assigned_team?.vehicle || "-"}</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="mb-4">
          ...
          <div className="overflow-x-auto border border-gray-200 rounded-md shadow-sm">
            <table className="w-full min-w-[800px] text-left border-collapse">
              <thead>
                <tr className="bg-blue-500 text-white">
                  <th className="p-3 font-semibold border border-blue-400 text-center">Số điện thoại</th>
                  <th className="p-3 font-semibold border border-blue-400 text-center">Họ và tên</th>
                  <th className="p-3 font-semibold border border-blue-400 text-center">Mức độ khẩn cấp</th>
                  <th className="p-3 font-semibold border border-blue-400 text-center">Trạng thái</th>
                  <th className="p-3 font-semibold border border-blue-400 text-center">Thời gian gửi</th>
                </tr>
              </thead>
              <tbody>
                <tr className="bg-white text-gray-700">
      ...
      <div className="min-h-screen bg-white pt-10 pb-10 px-4 flex flex-col items-center w-full mt-5">
        <div className="w-full max-w-3xl border-2 rounded-lg overflow-hidden mb-12 shadow-sm">
          <div className="bg-blue-500 py-6 text-center text-white">
            ...
            <p className="text-blue-100 text-sm md:text-base">Nhập số điện thoại để kiểm tra trạng thái yêu cầu cứu hộ</p>
          </div>
